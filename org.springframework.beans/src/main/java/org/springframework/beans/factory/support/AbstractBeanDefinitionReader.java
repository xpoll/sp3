...
public abstract class AbstractBeanDefinitionReader implements EnvironmentCapable, BeanDefinitionReader {
	...
	protected AbstractBeanDefinitionReader(BeanDefinitionRegistry registry) {
		...
		if (this.registry instanceof ResourceLoader) {
	        ...
	        System.err.println("** AbstractBeanDefinitionReader#构造方法--新建要使用的ResourceLoader。PathMatchingResourcePatternResolver");
		...
		if (this.registry instanceof EnvironmentCapable) {
            ...
            System.err.println("** AbstractBeanDefinitionReader#构造方法--新建要使用的environment。StandardEnvironment");
	...
	public int loadBeanDefinitions(String location, Set<Resource> actualResources) throws BeanDefinitionStoreException {
        System.err.println("** AbstractBeanDefinitionReader#.loadBeanDefinitions()--实际加载locations。");
		...
		if (resourceLoader instanceof ResourcePatternResolver) {
			...
			try {
		        System.err.println("** AbstractBeanDefinitionReader#.loadBeanDefinitions()--加载Resource[]");
